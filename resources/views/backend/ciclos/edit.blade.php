        ...
        <div class="card-body">
            ...
            <form action="{{ route('ciclos.update', $ciclo->id) }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="nombre" name="nombre" class="form-control" autofocus value="{{ $ciclo->nombre }}">
                    </div>
                </div>
                <button type="submit" class="btn btn-sm btn-primary">Editar Ciclo</button>
            </form>
        </div>
    </div>
